...
I have sample client applications which show how to send telemetry for
...
The packet format is detailed in these blog posts (https://blog.devmobile.co.nz/2018/09/03/rfm9x-iotcore-payload-addressing/) and (https://blog.devmobile.co.nz/2018/09/04/rfm9x-netmf-payload-addressing/)
